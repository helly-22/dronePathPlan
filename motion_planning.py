...
class MotionPlanning(Drone):
    ...
    def plan_path(self):
        ...
        print(
            f'Local => north : {local_north}, east : {local_east}, down : {local_down}')
        ...
        data = np.loadtxt(colliders_file, delimiter=',',
        ...
        waypoints = [[int(p[0] + north_offset), int(p[1] +
...
if __name__ == "__main__":
    ...
    goal_global_position = np.fromstring(
        f'{args.goal_lon},{args.goal_lat},{args.goal_alt}', dtype='Float64', sep=',')
